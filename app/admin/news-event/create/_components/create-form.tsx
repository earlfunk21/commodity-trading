...
import { createNewsEvent } from "@/actions/pooling/news-event.action";
...
const formSchema = z.object({
  title: z.string({
    required_error: "Title of the news and event is required",
  }),
  content: z.string(),
  show: z.boolean(),
...
export default function NewsEventCreateForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    const result = await createNewsEvent(values);
