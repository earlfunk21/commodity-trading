"use client";
import { uploadNewsEventImage } from "@/actions/pooling/news-event.action";
import {
  FileInput,
  FileUploader,
  FileUploaderContent,
...
export default function NewsEventImagesForm({ newsEventId }: Props) {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    for (const value of values.images) {
      ...
      await uploadNewsEventImage(newsEventId, formData);
    }
    form.reset();
  };
