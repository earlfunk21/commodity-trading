"use client";
import { removeBlogImage } from "@/actions/pooling/blog.action";
...
export default function RemoveBlogImage({ blogId, image, children }: Props) {
  const handleRemoveImage = async () => {
    await removeBlogImage(blogId, image);
  };
  return (
    <div
      key={image}
