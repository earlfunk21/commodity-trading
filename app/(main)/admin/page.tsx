import AdminCreateForm from "@/app/(main)/admin/_components/create-form";
import AdminData from "@/app/(main)/admin/_components/data";
import AdminPagination from "@/app/(main)/admin/_components/pagination";
