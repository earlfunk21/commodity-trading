import CommodityTypeListData from "@/app/(main)/commodities/[commoditySlug]/_components/data";
...
export default function CommodityPage({ params }: Props) {
  return (
    <main className="bg-gradient-to-r from-gray-800 via-gray-900 to-black py-4 pb-16">
      <div className="container mx-auto max-w-7xl">
        ...
        <Suspense fallback={<LoadingIcon />}>
          <CommodityTypeListData commoditySlug={params.commoditySlug} />
        </Suspense>
      </div>
    </main>
  );
