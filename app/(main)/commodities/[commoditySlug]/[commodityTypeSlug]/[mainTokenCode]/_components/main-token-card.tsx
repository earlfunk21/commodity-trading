          ...
          <div className="flex flex-col justify-between">
            ...
            <Button
              className={cn(
                ...
                "data-[state=open]:from-red-950 data-[state=open]:to-red-900",
                "border border-red-800",
                "transition-all duration-300 w-full hover:opacity-85"
              )}
              asChild>
              <Link href={`/holder/purchase-token/${mainToken.code}`}>Buy</Link>
            </Button>
          </div>
        </div>
      </CardContent>
